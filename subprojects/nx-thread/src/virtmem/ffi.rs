...
#[inline]
#[unsafe(no_mangle)]
pub unsafe extern "C" fn __nx_thread_virtmem_lock() {
    sys::virtmem_lock()
}
...
#[inline]
#[unsafe(no_mangle)]
pub unsafe extern "C" fn __nx_thread_virtmem_unlock() {
    sys::virtmem_unlock()
}
...
#[inline]
#[unsafe(no_mangle)]
pub unsafe extern "C" fn __nx_thread_virtmem_find_code_memory(
    size: usize,
    guard_size: usize,
) -> *mut u8 {
...
#[inline]
#[unsafe(no_mangle)]
pub unsafe extern "C" fn __nx_thread_virtmem_remove_reservation(rv: *mut VirtmemReservation) {
    unsafe { sys::virtmem_remove_reservation(rv) }
}
