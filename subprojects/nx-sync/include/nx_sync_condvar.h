 ...
 */
void __nx_sync_condvar_init(CondVar* c);
 ...
 */
Result __nx_sync_condvar_wait_timeout(CondVar* c, Mutex* m, uint64_t timeout);
 ...
 * @remark On function return, the underlying mutex is acquired.
 */
Result __nx_sync_condvar_wait(CondVar* c, Mutex* m);
 ...
 * @return Result code.
 */
Result __nx_sync_condvar_wake(CondVar* c, int num);
 ...
 * @return Result code.
 */
Result __nx_sync_condvar_wake_one(CondVar* c);
 ...
 * @return Result code.
 */
Result __nx_sync_condvar_wake_all(CondVar* c);
