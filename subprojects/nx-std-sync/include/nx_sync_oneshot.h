 ...
 */
void __nx_sync_oneshot_create(NxSyncOneshotSender** sender, NxSyncOneshotReceiver** receiver);
 ...
 */
void __nx_sync_oneshot_sender_free(NxSyncOneshotSender* sender);
 ...
 */
void __nx_sync_oneshot_receiver_free(NxSyncOneshotReceiver* receiver);
 ...
 */
int32_t __nx_sync_oneshot_send(NxSyncOneshotSender* sender, void* value);
 ...
 */
int32_t __nx_sync_oneshot_recv(NxSyncOneshotReceiver* receiver, void** out_value);
